<header class="header">
    <section class="sidebar-header bg-gray">
        <section class="d-flex justify-content-between flex-md-row-reverse px-2">
            ...
            <span><img class="logo" src="<?php echo e(asset('admin-assets/images/logo.png')); ?>" alt=""></span>
            ...
            <section>
                    <span class="mr-5">
                        <span id="search-area" class="search-area d-none">
                            ...
                            <i id="search-area-show" class="fas fa-search pointer"></i>
                        </span>
...
<?php /**PATH C:\Users\hamed.h\Desktop\admin panel\project\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>