            ...
            <section class="main-body-container">
                <section class="main-body-container-header">
                    ...
                    <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                        <a href="<?php echo e(route('admin.notify.email.create')); ?>" class="btn btn-info btn-sm rounded">ایجاد ایمیل جدید</a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hamed.h\Desktop\admin panel\project\resources\views/admin/notify/email/index.blade.php ENDPATH**/ ?>