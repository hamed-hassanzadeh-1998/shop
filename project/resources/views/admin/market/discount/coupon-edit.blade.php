                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" value="{{ old('code', $coupon->code) }}"class="form-control form-control-sm">
                            </div>
                            @error('code')
                        ...
                        <section class="col-12 col-md-6">
                         ...
                         <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="user_id" id="users" class="form-control form-control-sm" {{ $coupon->type == 0 ? 'disabled' : ''}}>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="amount" value="{{ old('amount', $coupon->amount) }}" class="form-control form-control-sm">
                            </div>
                            @error('amount')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="discount_ceiling" value="{{ old('discount_ceiling', $coupon->discount_ceiling) }}" class="form-control form-control-sm">
                            </div>
