                    ...
                    <section class="table-responsive">
                        <table class="table table-striped table-hover h-150">
                            ...
                            <tr>
                                <th>1</th>
                                <td>گوشی آیفون 12</td>
                                <td><img src="{{asset('admin-assets/images/avatar-2.jpeg')}}" alt=""></td>
                                <td>34,000 تومان</td>
                                <td>1 کیلو</td>
                                ...
                                <td class="width-8-rem text-left">
                                   <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                           <a href="{{route('admin.market.gallery.index')}}" class="dropdown-item text-right align-items-center justify-content-between"><i class="fa fa-images"></i> گالری</a>
