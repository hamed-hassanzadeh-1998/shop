...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page"> ویرایش سوالات متداول </li>
        </ol>
    </nav>
    <section class="row">
                            ...
                            <section class="row">
                                <section class="col-12 col-md-6 my-2">
                                    <div class="form-group">
                                        ...
                                        <input name="question" id="question" type="text" class="form-control form-control-sm" value="{{old('question',$faq->question)}}">
                                    </div>
                                    @error('question')
                                ...
                                <section class="col-12 my-2">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-sm" name="answer" id="body" cols="30" rows="10">{{old('answer',$faq->answer)}}</textarea>
                                    </div>
                                    @error('answer')
                                    <span class="alert_required bg-danger p-1 rounded text-white" role="alert">
                                        <strong>{{$message}}
                                ...
                                <section class="col-12 my-2">
                                    <div class="form-group">
                                        ...
                                        <input id="tags" type="hidden" name="tags" class="form-control form-control-sm" value="{{old('tags',$faq->tags)}}">
