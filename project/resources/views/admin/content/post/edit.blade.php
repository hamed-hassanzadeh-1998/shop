...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page"> ویرایش پست جدید</li>
        </ol>
    </nav>
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                <section class="main-body-container-header">
                    ...
                    <section>
                        <form id="form" action="{{route('admin.content.post.update',$post->id)}}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="category" name="category_id" class="form-control form-control-sm">
                                            @foreach($postCategories as $postCategory)
                                                ...
                                                <option
                                                    @if(old('category_id',$postCategory->id)==$postCategory->id) selected @endif
