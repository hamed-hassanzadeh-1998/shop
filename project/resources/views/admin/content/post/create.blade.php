                            ...
                            <section class="row">
                                ...
                                <section class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm">
                                            <option value="">دسته پست را انتخاب نمایید</option>
                                            <option value="">کالاهای الکترونیکی</option>
                                        </select>
                                    </div>
                                </section>
                                <section class="col-12 col-md-6">
                                ...
                                <section class="col-12 ">
                                    <div class="form-group">
                                        ...
                                        <textarea name="" id="body" class="form-control form-control-sm" rows="20"></textarea>
                                    </div>
                                </section>
                                <section class="col-12">
